...
# aug_label_dir = os.path.join(os.path.dirname(norm_base_label_dir), os.path.basename(norm_base_label_dir))  # 전처리 된 폴더에 증강 데이터 추가
# aug_image_dir = os.path.join(os.path.dirname(norm_base_image_dir), os.path.basename(norm_base_image_dir))  # 전처리 된 폴더에 증강 데이터 추가
aug_label_dir = os.path.join(os.path.dirname(norm_base_label_dir), os.path.basename(norm_base_label_dir) + '_aug')  # 증강 폴더 새로 생성 시 사용
aug_image_dir = os.path.join(os.path.dirname(norm_base_image_dir), os.path.basename(norm_base_image_dir) + '_aug')  # 증강 폴더 새로 생성 시 사용
